...
{
	//flag_on_off.flag_check_motion = !flag_on_off.flag_check_motion; // T_NOTE flag_motion set on off
	int err = 0;
#if DEBUG_PUBLISH_REDUCE_COLLISION_TEST_EN
	rx_ack_num++;
#endif
...
const mesh_cmd_sig_func_t mesh_cmd_sig_func[] = {
	...
	CMD_NO_STR(MODE_APP_BIND, 0, SIG_MD_CFG_CLIENT, SIG_MD_CFG_SERVER, mesh_cmd_sig_cfg_bind, MODE_APP_STATUS), // RD_EDIT bindall
