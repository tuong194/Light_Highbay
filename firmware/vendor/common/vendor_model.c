...
mesh_cmd_sig_func_t mesh_cmd_vd_func[] = {
    ...
    {RD_OPCODE_CALL_GROUP, 0, VENDOR_MD_LIGHT_C,VENDOR_MD_LIGHT_S, RD_Control_Group_By_SENSOR,  STATUS_NONE},
    {RD_OPCODE_TRAINING_2, 0, VENDOR_MD_LIGHT_C,VENDOR_MD_LIGHT_S, RD_Messenger_Training_2,  STATUS_NONE}
